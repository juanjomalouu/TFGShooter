...
void AEnemy1Blue::BeginPlay()
{
	Super::BeginPlay();

	DamageCollision2->OnComponentBeginOverlap.AddDynamic(this, &AEnemy1Blue::OnHit);
...
// Called every frame
void AEnemy1Blue::Tick(float DeltaTime)
{
...
void AEnemy1Blue::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	Super::SetupPlayerInputComponent(PlayerInputComponent);

}

void AEnemy1Blue::OnHit(UPrimitiveComponent* HitComp, AActor* OtherActor,
...
void AEnemy1Blue::OnSensed(const TArray<AActor*>& UpdatedActors)
{
...
void AEnemy1Blue::SetNewRotation(FVector TargetPosition, FVector CurrentPosition)
{
...
void AEnemy1Blue::DealDamage(float DamageAmount)
{
	Health -= DamageAmount;
